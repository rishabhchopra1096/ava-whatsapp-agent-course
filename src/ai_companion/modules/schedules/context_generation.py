...
class ScheduleContextGenerator:
    """Class to generate context about Pepper's current activity based on schedules."""
    ...
    def get_current_activity(cls) -> Optional[str]:
        """Get Pepper's current activity based on the current time and day of the week.
